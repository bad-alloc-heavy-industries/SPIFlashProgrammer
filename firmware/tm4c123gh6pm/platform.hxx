...
static auto &gpioBAPB{*reinterpret_cast<gpio_t *>(gpioBBaseAPB)};
static auto &gpioCAPB{*reinterpret_cast<gpio_t *>(gpioCBaseAPB)};
static auto &gpioDAPB{*reinterpret_cast<gpio_t *>(gpioDBaseAPB)};
static auto &ssi0{*reinterpret_cast<ssi_t *>(ssi0Base)};
static auto &ssi1{*reinterpret_cast<ssi_t *>(ssi1Base)};
static auto &ssi2{*reinterpret_cast<ssi_t *>(ssi2Base)};
static auto &ssi3{*reinterpret_cast<ssi_t *>(ssi3Base)};
static auto &uart0{*reinterpret_cast<uart_t *>(uart0Base)};
static auto &uart1{*reinterpret_cast<uart_t *>(uart1Base)};
static auto &uart2{*reinterpret_cast<uart_t *>(uart2Base)};
static auto &uart3{*reinterpret_cast<uart_t *>(uart3Base)};
static auto &uart4{*reinterpret_cast<uart_t *>(uart4Base)};
static auto &uart5{*reinterpret_cast<uart_t *>(uart5Base)};
static auto &uart6{*reinterpret_cast<uart_t *>(uart6Base)};
static auto &uart7{*reinterpret_cast<uart_t *>(uart7Base)};
static auto &i2c0{*reinterpret_cast<i2c_t *>(i2c0Base)};
static auto &i2c1{*reinterpret_cast<i2c_t *>(i2c1Base)};
static auto &i2c2{*reinterpret_cast<i2c_t *>(i2c2Base)};
static auto &i2c3{*reinterpret_cast<i2c_t *>(i2c3Base)};
static auto &gpioEAPB{*reinterpret_cast<gpio_t *>(gpioEBaseAPB)};
static auto &gpioFAPB{*reinterpret_cast<gpio_t *>(gpioFBaseAPB)};
static auto &pwm0{*reinterpret_cast<pwm_t *>(pwm0Base)};
static auto &pwm1{*reinterpret_cast<pwm_t *>(pwm1Base)};
static auto &qei0{*reinterpret_cast<qei_t *>(qei0Base)};
static auto &qei1{*reinterpret_cast<qei_t *>(qei1Base)};
static auto &timer0{*reinterpret_cast<timer_t *>(timer0Base)};
static auto &timer1{*reinterpret_cast<timer_t *>(timer1Base)};
static auto &timer2{*reinterpret_cast<timer_t *>(timer2Base)};
static auto &timer3{*reinterpret_cast<timer_t *>(timer3Base)};
static auto &timer4{*reinterpret_cast<timer_t *>(timer4Base)};
static auto &timer5{*reinterpret_cast<timer_t *>(timer5Base)};
static auto &wtimer0{*reinterpret_cast<timer_t *>(wtimer0Base)};
static auto &wtimer1{*reinterpret_cast<timer_t *>(wtimer1Base)};
static auto &adc0{*reinterpret_cast<adc_t *>(adc0Base)};
static auto &adc1{*reinterpret_cast<adc_t *>(adc1Base)};
static auto &comp{*reinterpret_cast<comp_t *>(compBase)};
static auto &can0{*reinterpret_cast<can_t *>(can0Base)};
static auto &can1{*reinterpret_cast<can_t *>(can1Base)};
static auto &wtimer2{*reinterpret_cast<timer_t *>(wtimer2Base)};
static auto &wtimer3{*reinterpret_cast<timer_t *>(wtimer3Base)};
static auto &wtimer4{*reinterpret_cast<timer_t *>(wtimer4Base)};
static auto &wtimer5{*reinterpret_cast<timer_t *>(wtimer5Base)};
static auto &usb{*reinterpret_cast<usb_t *>(usbBase)};
static auto &gpioA{*reinterpret_cast<gpio_t *>(gpioABaseAHB)};
static auto &gpioB{*reinterpret_cast<gpio_t *>(gpioBBaseAHB)};
static auto &gpioC{*reinterpret_cast<gpio_t *>(gpioCBaseAHB)};
static auto &gpioD{*reinterpret_cast<gpio_t *>(gpioDBaseAHB)};
static auto &gpioE{*reinterpret_cast<gpio_t *>(gpioEBaseAHB)};
static auto &gpioF{*reinterpret_cast<gpio_t *>(gpioFBaseAHB)};
static auto &eeprom{*reinterpret_cast<eeprom_t *>(eepromBase)};
static auto &sysExc{*reinterpret_cast<sysExc_t *>(sysExcBase)};
static auto &hib{*reinterpret_cast<hib_t *>(hibBase)};
