...
struct gpio_t final
{
	...
	volatile uint32_t adcCtrl; // GPIO ADC Control
	volatile uint32_t dmaCtrl; // GPIO DMA Control
};
...
auto &watchdog0{*reinterpret_cast<watchdog_t *>(watchdog0Base)};
auto &watchdog1{*reinterpret_cast<watchdog_t *>(watchdog1Base)};
auto &gpioAAPB{*reinterpret_cast<gpio_t *>(gpioABaseAPB)};
auto &gpioBAPB{*reinterpret_cast<gpio_t *>(gpioBBaseAPB)};
auto &gpioCAPB{*reinterpret_cast<gpio_t *>(gpioCBaseAPB)};
auto &gpioDAPB{*reinterpret_cast<gpio_t *>(gpioDBaseAPB)};
auto &ssi0{*reinterpret_cast<ssi_t *>(ssi0Base)};
auto &ssi1{*reinterpret_cast<ssi_t *>(ssi1Base)};
auto &ssi2{*reinterpret_cast<ssi_t *>(ssi2Base)};
auto &ssi3{*reinterpret_cast<ssi_t *>(ssi3Base)};
auto &uart0{*reinterpret_cast<uart_t *>(uart0Base)};
auto &uart1{*reinterpret_cast<uart_t *>(uart1Base)};
auto &uart2{*reinterpret_cast<uart_t *>(uart2Base)};
auto &uart3{*reinterpret_cast<uart_t *>(uart3Base)};
auto &uart4{*reinterpret_cast<uart_t *>(uart4Base)};
auto &uart5{*reinterpret_cast<uart_t *>(uart5Base)};
auto &uart6{*reinterpret_cast<uart_t *>(uart6Base)};
auto &uart7{*reinterpret_cast<uart_t *>(uart7Base)};
auto &i2c0{*reinterpret_cast<i2c_t *>(i2c0Base)};
auto &i2c1{*reinterpret_cast<i2c_t *>(i2c1Base)};
auto &i2c2{*reinterpret_cast<i2c_t *>(i2c2Base)};
auto &i2c3{*reinterpret_cast<i2c_t *>(i2c3Base)};
auto &gpioEAPB{*reinterpret_cast<gpio_t *>(gpioEBaseAPB)};
auto &gpioFAPB{*reinterpret_cast<gpio_t *>(gpioFBaseAPB)};
auto &pwm0{*reinterpret_cast<pwm_t *>(pwm0Base)};
auto &pwm1{*reinterpret_cast<pwm_t *>(pwm1Base)};
auto &qei0{*reinterpret_cast<qei_t *>(qei0Base)};
auto &qei1{*reinterpret_cast<qei_t *>(qei1Base)};
auto &timer0{*reinterpret_cast<timer_t *>(timer0Base)};
auto &timer1{*reinterpret_cast<timer_t *>(timer1Base)};
auto &timer2{*reinterpret_cast<timer_t *>(timer2Base)};
auto &timer3{*reinterpret_cast<timer_t *>(timer3Base)};
auto &timer4{*reinterpret_cast<timer_t *>(timer4Base)};
auto &timer5{*reinterpret_cast<timer_t *>(timer5Base)};
auto &wtimer0{*reinterpret_cast<timer_t *>(wtimer0Base)};
auto &wtimer1{*reinterpret_cast<timer_t *>(wtimer1Base)};
auto &adc0{*reinterpret_cast<adc_t *>(adc0Base)};
auto &adc1{*reinterpret_cast<adc_t *>(adc1Base)};
auto &comp{*reinterpret_cast<comp_t *>(compBase)};
auto &can0{*reinterpret_cast<can_t *>(can0Base)};
auto &can1{*reinterpret_cast<can_t *>(can1Base)};
auto &wtimer2{*reinterpret_cast<timer_t *>(wtimer2Base)};
auto &wtimer3{*reinterpret_cast<timer_t *>(wtimer3Base)};
auto &wtimer4{*reinterpret_cast<timer_t *>(wtimer4Base)};
auto &wtimer5{*reinterpret_cast<timer_t *>(wtimer5Base)};
auto &usb{*reinterpret_cast<usb_t *>(usbBase)};
auto &gpioA{*reinterpret_cast<gpio_t *>(gpioABaseAHB)};
auto &gpioB{*reinterpret_cast<gpio_t *>(gpioBBaseAHB)};
auto &gpioC{*reinterpret_cast<gpio_t *>(gpioCBaseAHB)};
auto &gpioD{*reinterpret_cast<gpio_t *>(gpioDBaseAHB)};
auto &gpioE{*reinterpret_cast<gpio_t *>(gpioEBaseAHB)};
auto &gpioF{*reinterpret_cast<gpio_t *>(gpioFBaseAHB)};
auto &eeprom{*reinterpret_cast<eeprom_t *>(eepromBase)};
auto &sysExc{*reinterpret_cast<sysExc_t *>(sysExcBase)};
auto &hib{*reinterpret_cast<hib_t *>(hibBase)};
auto &flashCtrl{*reinterpret_cast<flashCtrl_t *>(flashCtrlBase)};
